...
double getWidth(double size) {
  if (AppTamanho.orientation == Orientation.portrait) {
    return AppTamanho.safeBlockHorizontal * size;
  } else {
    return AppTamanho.safeBlockVertical * size;
  }
}
...
double getSmallPadding() {
  debugPrint("Small: ${AppTamanho.safeBlockVertical * 0.6}");
  return AppTamanho.safeBlockVertical * 0.6;
}

double getMediumPadding() {
  debugPrint("Medium: ${AppTamanho.safeBlockVertical * 1.2}");
  return AppTamanho.safeBlockVertical * 1.2;
}

double getLargePadding() {
  debugPrint("Large: ${AppTamanho.safeBlockVertical * 2.4}");
  return AppTamanho.safeBlockVertical * 0.8;
}
